...
| Port-Channel6 | host2-DC1_Connection_host2-dc1 | switched | access | 20 | - | - | - | - | 6 | - |
...
interface Port-Channel6
   description host2-DC1_Connection_host2-dc1
   no shutdown
   switchport
...
| --- | ------------------- | ------------ |
| Kirk | 192.168.101.3:100 | connected |
...
router bgp 65103
   ...
   neighbor 192.168.92.5 description leaf4-DC1
