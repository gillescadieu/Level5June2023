...
| Port-Channel6 | host1-DC1_connection_host1-dc1 | switched | access | 10 | - | - | - | - | 6 | - |
...
interface Port-Channel6
   description host1-DC1_connection_host1-dc1
   no shutdown
   switchport
...
| --- | ------------------- | ------------ |
| Kirk | 192.168.101.2:100 | connected |
...
router bgp 65101
   ...
   neighbor 192.168.92.0 description leaf1-DC1
