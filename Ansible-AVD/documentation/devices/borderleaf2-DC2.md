...
| --------- | --------------- | ------------ | --------- |
| dc2_mlag3 | Vlan4094 | 192.168.91.8 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC2_Ethernet7 | routed | - | 192.168.203.41/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC2_Ethernet7 | routed | - | 192.168.203.43/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC2_Ethernet7 | routed | - | 192.168.203.45/31 | default | 1550 | False | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.201.6:10010 | 10010:10010 | - | - | learned |
| 20 | 192.168.201.6:10020 | 10020:10020 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Kirk | 192.168.201.6:100 | connected |
...
router bgp 65299
   ...
   neighbor 192.168.92.8 description borderleaf1-DC2
   ...
   neighbor 192.168.203.40 description spine1-DC2_Ethernet7
   neighbor 192.168.203.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.42 remote-as 65200
   neighbor 192.168.203.42 description spine2-DC2_Ethernet7
   neighbor 192.168.203.44 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.44 remote-as 65200
   neighbor 192.168.203.44 description spine3-DC2_Ethernet7
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 10
      rd 192.168.201.6:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 20
      rd 192.168.201.6:10020
