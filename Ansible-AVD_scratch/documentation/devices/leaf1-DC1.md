...
| Ethernet5 | P2P_LINK_TO_SPINE3-DC1_Ethernet1 | routed | - | 192.168.103.5/31 | default | 1550 | False | - | - |
...
!
interface Ethernet5
   description P2P_LINK_TO_SPINE3-DC1_Ethernet1
   no shutdown
   mtu 1550
   no switchport
...
router bgp 65100
   ...
   neighbor 192.168.103.4 description spine3-DC1_Ethernet1
